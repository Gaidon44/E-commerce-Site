                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-rale w-25">
                                ...
                                <input type="text" data-id="<?php echo $item['item_id'] ?? '0'; ?>" class="qty_input border px-3 w-50 bg-light" disabled value="1" placeholder="1">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <a href="./buy.php" class="btn btn-warning mt-3" role="button">Proceed To buy</a>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
